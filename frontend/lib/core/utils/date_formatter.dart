...
class DateFormatter {
  ...
  int getWeekOfMonth(DateTime date) {
    ...
    final remainingDayAfterFirstWeek = date.day - lastDayOfFirstWeek;
    return (remainingDayAfterFirstWeek / 7).ceil() + 1;
  }
  ...
  String relativeToNow(String date) {
    ...
    if ((diff.inDays / 365).floor() >= 2) {
      ...
      return '${diff.inMinutes} minures ago';
    } else if (diff.inMinutes >= 1) {
      return '1 minures ago';
